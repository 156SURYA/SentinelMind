...
def handle_client(client, addr):
    ...
    try:
        ...
        try:
            ...
            with open(
                "honeypot/attacker_profiles.json",
                "r"
            ) as f:
        ...
        print(
            f"🎯 Predicted Next Action: "
            f"{prediction['predicted_next_action']}"
        )
